...
public:
	...
	TBRD_FpgaId() : TReadOnlyConfig(BRD_FpgaID, ofsFpgaID){Debug("ReadOnlyConfig(DId,ofsFpgaID);");};
	TBRD_FpgaId(TBytes FromBytes) : TReadOnlyConfig(FromBytes){DId = BRD_FpgaID; offset = ofsFpgaID; }
...
public:
	TBRD_Features() : TReadOnlyConfig<__u8>( BRD_Features, ofsFeatures){};
